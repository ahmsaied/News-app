...
public class BBCNewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new BBCNewsActivity.ReadJSON().execute("https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=d0eccea4ff764654b4f7b65b1dc2a664");
            }
        });
    }
            ...
            try {
                ...
                lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(BBCNewsActivity.this, details.class);
